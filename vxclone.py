...
KANJI = [  # box, 0x56d7, used as placeholder for unidentified Kanji
    ...
    # deer, gift,   ocean,  shingle, partition, school, salt pan, place,
    0x9e7f, 0x8cc0, 0x6d77, 0x676e, 0x9694, 0x5b66, 0x6f5f, 0x9593,
    # close, grass, cliff,  grave,  machine, air,   city,   high,
    0x95a2, 0x83c5, 0x5ca9, 0x5893, 0x6a5f, 0x6c17, 0x57ce, 0x5c90,
    # quick, save,  nine,   capital, teach, bridge, jade,   forbid,
    0x6025, 0x6551, 0x4e5d, 0x4eac, 0x6559, 0x6a4b, 0x7389, 0x7981,
    # gold, area,   empty,  bright, chestnut, group, bureau, form
    0x91d1, 0x533a, 0x7a7a, 0x718a, 0x6817, 0x7fa4, 0x90e1, 0x5f62,
    # guard, month, county, origin, words,  limit,  armory, enter,
    0x8b66, 0x6708, 0x770c, 0x539f, 0x8a00, 0x9650, 0x5eab, 0x8fbc,
    # old,  five,   words,  mouth,  wide,   sail,   tall,   join,
    0x53e4, 0x4e94, 0x8a9e, 0x53e3, 0x5e83, 0x822a, 0x9ad8, 0x5408,
    # carve, nation, dark,  root,   assist, disaster, headland, west,
    0x523b, 0x56fd, 0x9ed2, 0x6839, 0x4f50, 0x707d, 0x57fc, 0x897f,
    # hillside, rough, examine, note, marsh, swamp, three,  mountain,
    # (6ca2 and 6fa4 are synonymous and homonymous: "ze'")
    0x5742, 0x5d0e, 0x5bdf, 0x672d, 0x6ca2, 0x6fa4, 0x4e09, 0x5c71,
    # four, scholar, market, stop,  paper,  grow,   son,    time,
    0x56db, 0x58eb, 0x5e02, 0x6b62, 0x7d19, 0x6ecb, 0x5150, 0x6642,
    # show, self,   seven,  take,   hand,   different, wine, state,
    0x793a, 0x81ea, 0x4e03, 0x53d6, 0x624b, 0x6b8a, 0x9152, 0x5dde,
    # autumn, assemble, ten, heavy, book,   small,  vanish, top,
    0x79cb, 0x96c6, 0x5341, 0x91cd, 0x66f8, 0x5c0f, 0x6d88, 0x4e0a,
    # new,  forest, spirit, water,  system, blue,   quiet,  right,
    0x65b0, 0x68ee, 0x795e, 0x6c34, 0x5236, 0x9752, 0x9759, 0x53f3,
    # build, immortal, thousand, stream, thread, ship, mutual, reel,
    0x8a2d, 0x4ed9, 0x5343, 0x5ddd, 0x7dda, 0x8239, 0x76f8, 0x7d9b,
    # see off, bind, measure, continue, village, team, platform, big,
    0x9001, 0x675f, 0x6e2c, 0x7d9a, 0x6751, 0x968a, 0x53f0, 0x5927,
    # sequence, rain, single, know, central, hall,  dynasty, raised path,
    0x7b2c, 0x6edd, 0x5358, 0x77e5, 0x4e2d, 0x5e81, 0x671d, 0x753a,
    # hear, long,   bird,   decide, iron,   sky,    field,  electricity,
    0x8074, 0x9577, 0x9ce5, 0x5b9a, 0x9244, 0x5929, 0x7530, 0x96fb,
    # door, metropolis, degree, soil, island, east, rob,    rattan,
    0x6238, 0x90fd, 0x5ea6, 0x571f, 0x5cf6, 0x6771, 0x76d7, 0x85e4,
    # path, virtue, special, read,  oak,    but,    rope,   two,
    0x9053, 0x5fb3, 0x7279, 0x8aad, 0x6803, 0x5948, 0x7e04, 0x4e8c,
    # sun,  lake,   thick,  can,    horse,  sell,   big ship, eight,
    0x65e5, 0x6cbc, 0x6fc3, 0x80fd, 0x99ac, 0x58f2, 0x8236, 0x516b,
    # slope, rice,  tail,   beauty, hundred, express, second, creek,
    0x962a, 0x98ef, 0x5c3e, 0x5a9b, 0x767e, 0x8868, 0x79d2, 0x6d5c,
    # rich, prefecture, mound, military, part, piece, happiness, divide,
    0x5bcc, 0x5e9c, 0x961c, 0x6b66, 0x90e8, 0x5e45, 0x798f, 0x5206,
    # literature, interval, soldier, equal, put, fragrant, defend, north,
